...
* The original package name 'com.saas.avocado.spring-data-demo.examples' is invalid and this project uses 'com.saas.avocado.springdatademo.examples' instead.
